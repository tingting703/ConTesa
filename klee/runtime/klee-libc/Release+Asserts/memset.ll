...
entry:
  ...
  call void @llvm.dbg.declare(metadata !{i8** %a}, metadata !14), !dbg !18
  %1 = load i8** %dst_addr, align 8, !dbg !18
  store i8* %1, i8** %a, align 8, !dbg !18
  br label %bb1, !dbg !18

bb:                                               ; preds = %bb1
  %2 = load i32* %s_addr, align 4, !dbg !19
  %3 = trunc i32 %2 to i8, !dbg !19
  %4 = load i8** %a, align 8, !dbg !19
  store i8 %3, i8* %4, align 1, !dbg !19
  %5 = load i8** %a, align 8, !dbg !19
  %6 = getelementptr inbounds i8* %5, i64 1, !dbg !19
  store i8* %6, i8** %a, align 8, !dbg !19
  br label %bb1, !dbg !19

bb1:                                              ; preds = %bb, %entry
  %7 = load i64* %count_addr, align 8, !dbg !20
  %8 = sub i64 %7, 1, !dbg !20
  store i64 %8, i64* %count_addr, align 8, !dbg !20
  %9 = load i64* %count_addr, align 8, !dbg !20
  %10 = icmp ne i64 %9, -1, !dbg !20
  br i1 %10, label %bb, label %bb2, !dbg !20

bb2:                                              ; preds = %bb1
  %11 = load i8** %dst_addr, align 8, !dbg !21
  store i8* %11, i8** %0, align 8, !dbg !21
  %12 = load i8** %0, align 8, !dbg !21
  store i8* %12, i8** %retval, align 8, !dbg !21
  br label %return, !dbg !21

return:                                           ; preds = %bb2
  %retval3 = load i8** %retval, !dbg !21
  ret i8* %retval3, !dbg !21
}
...
!1 = metadata !{i32 589865, metadata !"memset.c", metadata !"/home/tyu/Documents/bugredx/klee2.9/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"memset.c", metadata !"/home/tyu/Documents/bugredx/klee2.9/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!18 = metadata !{i32 13, i32 0, metadata !15, null}
!19 = metadata !{i32 15, i32 0, metadata !15, null}
!20 = metadata !{i32 14, i32 0, metadata !15, null}
!21 = metadata !{i32 16, i32 0, metadata !15, null}
