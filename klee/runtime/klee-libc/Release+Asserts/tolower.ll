...
define i32 @tolower(i32 %ch) nounwind readonly {
entry:
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"tolower", metadata !"tolower", metadata !"tolower", metadata !1, i32 10, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32)* @tolower} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 589865, metadata !"tolower.c", metadata !"/home/tyu/Documents/bugredx/klee2.9/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"tolower.c", metadata !"/home/tyu/Documents/bugredx/klee2.9/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
