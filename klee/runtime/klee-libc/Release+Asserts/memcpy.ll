...
define i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) nounwind {
entry:
...
bb2:                                              ; preds = %bb1
  %14 = load i8** %destaddr_addr, align 8, !dbg !24
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"memcpy", metadata !"memcpy", metadata !"memcpy", metadata !1, i32 12, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i8* (i8*, i8*, i64)* @memcpy} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 589865, metadata !"memcpy.c", metadata !"/home/tyu/Documents/bugredx/klee2.9/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"memcpy.c", metadata !"/home/tyu/Documents/bugredx/klee2.9/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
