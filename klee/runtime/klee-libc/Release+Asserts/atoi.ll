...
entry:
  ...
  call void @llvm.dbg.declare(metadata !{i8** %str_addr}, metadata !9), !dbg !10
  store i8* %str, i8** %str_addr
  %1 = load i8** %str_addr, align 8, !dbg !11
  %2 = call i64 @strtol(i8* noalias %1, i8** noalias null, i32 10) nounwind, !dbg !11
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"atoi", metadata !"atoi", metadata !"atoi", metadata !1, i32 35, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i8*)* @atoi} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 589865, metadata !"atoi.c", metadata !"/home/tyu/Documents/bugredx/klee2.9/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"atoi.c", metadata !"/home/tyu/Documents/bugredx/klee2.9/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
